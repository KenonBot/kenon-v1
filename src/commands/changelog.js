...
module.exports = {
  ...
  async execute(interaction, client) {
    const pingembed = new EmbedBuilder()
      ...
      .addFields(
        { name: 'New Guess the Picture Category!', value: '>>> Attention, Railway Fans!\nWe\'ve added the Category "Trains". This isn\'t big at the moment, but we are going to add more questions soon!'},
        { name: 'Introducing... Job System!', value: '>>> It\'s now possible to earn credits by working! Select your Job and you are able to work every 90 Minutes.'},
        )
