...
const uri = 'mongodb+srv://admin:SixrYaxUeu8KwDhA@cluster0.rayv48e.mongodb.net/?retryWrites=true&w=majority';
...
module.exports = {
    data: new SlashCommandBuilder()
      ...
      .addUserOption(option => option.setName('recipient').setDescription('The user to pay credits to.').setRequired(true))
      .addIntegerOption(option => option.setName('amount').setDescription('The amount of credits to pay.').setRequired(true)),
    async execute(interaction) {
      ...
      try {
        ...
        if (!sender) {
            ...
            .setDescription('> You haven\'t used the Bot before. You cannot pay Credits to other Users.');
        ...
        if (recipient) {
          ...
          if (recipientUser) {
            ...
            .setDescription(`> **You paid** <:kenon_coin:1117946111034937424>\`${amount}\` to <@${recipientId}>.\n> **Taxes:** <:kenon_coin:1117946111034937424>\`${tax}\``)
        ...
        interaction.reply('An error occurred while processing the payment. This has been logged.');
      }
    },
  };