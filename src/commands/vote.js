...
module.exports = {
  ...
  async execute(interaction, client) {
    const pingembed = new EmbedBuilder()
      ...
      .setDescription("> Our team works hard to provide you the best experience. We're thankful for every Supporter! Also, leave a Review if you want, we're open for suggestions ;)")
      .addFields(
        {
