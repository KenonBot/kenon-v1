  ...
  async execute(interaction) {
    ...
    const generateRound = async () => {
      ...
      const time = new EmbedBuilder()
        ...
        .setDescription(`> The correct answer was **${randomPicture.answer}**.`);

      const wrong = new EmbedBuilder()
        .setColor('#35393e')
        .setDescription('<:kcross:1135001034750709832> **〢 Wrong answer. Try again!**');

      const right = new EmbedBuilder()
        .setColor('#35393e')
        .setTitle('<:kcheck:1135000999212355647> **〢 Correct Answer!**')
        .setDescription('> You\'ve been awarded <:kcoin:1135002536777093170> **`5`** for the correct Answer.');
      ...
      const collector = interaction.channel.createMessageCollector({ filter, time: 14000 });
